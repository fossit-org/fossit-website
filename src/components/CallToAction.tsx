  ...
  return (
    <section className="bg-[#492170] py-20 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <p className="text-[#e7cfff] mb-8 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-6 mt-16">
          <div className="text-center">
            <div className="text-white mb-2">1,000+</div>
            <div className="text-[#e7cfff]">Developers</div>
          </div>
          <div className="text-center">
            <div className="text-white mb-2">500+</div>
            <div className="text-[#e7cfff]">Projects</div>
          </div>
          <div className="text-center">
            <div className="text-white mb-2">10K+</div>
            <div className="text-[#e7cfff]">Contributions</div>
          </div>
          <div className="text-center">
            <div className="text-white mb-2">25+</div>
            <div className="text-[#e7cfff]">Badges</div>
          </div>
        </div>
      </div>
    </section>
